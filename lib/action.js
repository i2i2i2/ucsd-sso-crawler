...
function checkSuccess(phantom, url, task, reject, resolve, isNewPage) {
  ...
  return function(newPage) {
    ...
    phantom.pages[isNewPage? 1 : 0].get("url", function(err, openedUrl) {
      ...
      if (err) {
        ...
        phantom.pages[0].onPageCreated = function() {};
        phantom.pages[0].onLoadFinished = function() {};
    ...
    return new Promise((resolve, reject) => {
      ...
      phantom.pages[0].onUrlChanged = (url) => {
        ...
        if (url == TRITONLINK_LOGINED_URL) {
          phantom.pages[0].onUrlChanged = function() {};
...
exports.openDegreeAuditReport = (phantom) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    Helper.assertFailedIn(5000, TASKS[5], reject, phantom);
  });
};
...
exports.openAcademicHistory = (phantom) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    Helper.assertFailedIn(5000, TASKS[7], reject, phantom);
  });
}
